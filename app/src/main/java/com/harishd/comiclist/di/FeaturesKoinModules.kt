...
import com.harishd.comiclist.MainViewModel
import com.harishd.comiclist.common.ApplicationContext
import com.harishd.comiclist.common.IApplicationContext
import com.harishd.comiclist.data.local.AppSharedPreference
import com.harishd.comiclist.data.local.database.ComicsDatabase
import com.harishd.comiclist.feature.comicList.module.data.ComicRepository
import com.harishd.comiclist.feature.comicList.module.data.IComicRepository
import com.harishd.comiclist.feature.comicList.module.useCase.GetComicsUseCase
import com.harishd.comiclist.feature.comicList.screens.ComicViewModel
import com.harishd.comiclist.feature.details.ComicDetailsViewModel
import com.harishd.comiclist.feature.details.module.UpdateComicFavoriteUseCase
import com.harishd.comiclist.feature.favoriteList.FavoriteViewModel
import com.harishd.comiclist.feature.favoriteList.GetFavoriteComicsUseCase
import com.harishd.comiclist.feature.search.SearchUseCase
import com.harishd.comiclist.feature.search.SearchViewModel
